...
use crate::{
    ...
    rules::{
        ...
        normalize_comment_spacing::NormalizeCommentSpacing, reflow_calls::ReflowCalls,
...
impl Config {
    ...
    /// relocated call through, `None` where that rule is off.
    pub(crate) fn call_seating(&self) -> Option<ReflowCalls> {
        self.rules
            .reflow_calls
            .enabled
            .then(|| ReflowCalls::from_config(self))
    }

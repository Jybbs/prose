...
/// handed to the walker's own dispatch. `VerbatimOpen` opens or
/// stands as a passthrough region (section underline, doctest,
/// field list, or directive) and `Verbatim` carries a line inside
/// an open region.
#[derive(Debug)]

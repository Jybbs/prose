...
use crate::{
    config::{
        ...
        ModernizeAnnotationsConfig, PreferFstringConfig, ReassignedConstantsConfig,
    ...
    rules::{
        ...
        modernize_annotations::ModernizeAnnotations, prefer_fstring::PreferFstring,
...
register_rules! {
    ...
    "prefer-fstring":            prefer_fstring:            PreferFstringConfig        => PreferFstring           => ["collection-layout"] => "convert `%` or `str.format()` interpolation to an f-string",

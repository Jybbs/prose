...
use crate::{
    ...
    rules::{
        ...
        string_concat_layout::StringConcatLayout, strip_align_padding::StripAlignPadding,
...
register_rules! {
    ...
    "string-concat-layout":  string_concat_layout:  ToggleOnly                 => StringConcatLayout   => ["chain-layout", "collection-layout", "call-layout", "signature-layout"] => "break an implicitly concatenated string run to one literal per line",

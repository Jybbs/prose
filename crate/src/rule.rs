...
use crate::{
    config::{
        ...
        ModernizeAnnotationsConfig, ReassignedConstantsConfig, SignatureLayoutConfig,
    ...
    rules::{
        ...
        modernize_annotations::ModernizeAnnotations, reassigned_constants::ReassignedConstants,
...
register_rules! {
    "shed-backslash-continuations": shed_backslash_continuations: ToggleOnly                 => ShedBackslashContinuations => [] => "shed a backslash line continuation",
    ...
    "shed-parentheses":             shed_parentheses:             ToggleOnly                 => ShedParentheses            => ["shed-backslash-continuations"] => "shed a redundant grouping parenthesis pair",

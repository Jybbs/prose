...
use crate::{
    ...
    rules::{
        ...
        step_narration::StepNarration, string_concat_layout::StringConcatLayout,
...
register_rules! {
    ...
    "string-concat-layout":      string_concat_layout:      ToggleOnly                => StringConcatLayout      => ["collection-layout", "call-layout", "signature-layout"] => "break an implicitly concatenated string run to one literal per line",

...
use crate::{
    ...
    rules::{
        ...
        blank_lines::BlankLines, call_layout::CallLayout, chain_layout::ChainLayout,
        collection_layout::CollectionLayout, comment_spacing::CommentSpacing,
        ...
        modernize_annotations::ModernizeAnnotations, normalize_comparisons::NormalizeComparisons,
        normalize_literals::NormalizeLiterals, prune_inert_imports::PruneInertImports,
...
register_rules! {
    ...
    "bare-super":                   bare_super:                   ToggleOnly                 => BareSuper                  => [],

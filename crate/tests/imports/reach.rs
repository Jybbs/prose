...
pub(crate) enum Reach {
    ...
    Absent,
    /// The import that failed named the module itself or a package holding
...
impl Reach {
    ...
    /// module a failed import named is checked first, the exception second,
    /// and the path third, since a module written for another platform often
    /// raises an error that does not name that platform.

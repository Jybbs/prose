...
import { withFallbackSync } from '../shared/with-fallback'

const SITE_PREFIX = 'site/'
const MD_SUFFIX   = '.md'

export function buildPageTimestamps(repoRoot: string): Map<string, number> {
  return withFallbackSync('page-timestamps:git-log', () => parseGitTimestamps(execFileSync(
    'git',
...
export function parseGitTimestamps(raw: string): Map<string, number> {

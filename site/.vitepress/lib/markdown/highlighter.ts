...
// sandbox surfaces share, `getSingletonHighlighterCore` returning one instance
// per set of options to both callers. The core and its regex engine load
// through a dynamic import, which places them in a chunk fetched at the first
// highlight and keeps them out of the shared theme chunk.

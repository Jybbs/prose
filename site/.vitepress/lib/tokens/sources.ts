...
export const SOURCES: Record<Domain, readonly TokenSource[]> = {
  ...
  'config-key': [
    ...
    { key: 'collapse',                    href: '/reference/configuration#per-rule-facets',       blurb: 'Join a fitting multi-line construct back onto one line.' },
    ...
    { key: 'group-constants',             href: '/reference/configuration#per-rule-facets',       blurb: 'Cluster each band by subcategory before sorting by name.' },
    ...
    { key: 'split-plain',                 href: '/reference/configuration#per-rule-facets',       blurb: 'Break a comma-joined `import a, b` into one statement per module.' },

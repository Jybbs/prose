---
description: "The rules that rewrite a token, a line, or a spelling once a statement's layout is settled."
---
...
For enabling or disabling any of these rules, see the [**Configuration**](/reference/configuration) reference. For the pipeline order they run in, see the [**Pipeline Order**](/reference/pipeline-order) reference.

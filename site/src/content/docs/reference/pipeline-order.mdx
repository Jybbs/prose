...
import PipelineOrder from '../../../components/reference/PipelineOrder.astro'
...
Each rule's edits shape the source the next rule reads, with the kinds of dependency below driving the ordering.

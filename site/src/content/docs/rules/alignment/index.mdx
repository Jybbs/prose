...
import RuleCardList from '../../../../components/rules/RuleCardList.astro'
...
For the per-rule facets, see the [**Configuration**](/reference/configuration) reference. For the math the rules share, see the [[aligner]] primitive. The [[colon-targets]] walker drives the `:` contexts the alignment rules read against.
